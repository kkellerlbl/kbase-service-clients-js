...
function Workspace(url, auth, auth_cb) {
    ...
    this.get_permissions_mass_async = function (mass, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_permissions_mass", [mass], 1, _callback, _error_callback);
    };
    ...
    this.get_names_by_prefix_async = function (params, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Workspace.get_names_by_prefix", [params], 1, _callback, _error_callback);
    };
